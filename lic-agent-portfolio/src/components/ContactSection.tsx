...
export function ContactSection() {
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Email",
      value: "balram.lic02431@gmail.com",
      href: "mailto:balram.lic02431@gmail.com",
    },
    {
      icon: <MapPin className="h-5 w-5" />,
      title: "Office Address",
      value: "Near Bank of India, Dodi, Khalilabad, MP - 466116",
      href: "https://maps.app.goo.gl/gXK6zCHaadey3QJ59",
    },
    {
      icon: <Building className="h-5 w-5" />,
      title: "LIC Branch",
      value: "Khalilabad Branch (28L), Uttar Pradesh",
      href: null,
    },
    {
    ...
    },
    {
      ...
      title: "Appointments",
      value: "Available for home visits",
      href: null,
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Let's Discuss Your <span className="text-licBlue">Insurance Needs</span>
          </h2>
          <p className="text-gray-600 text-lg">
            I'm always available to answer your questions and help you find the right insurance solutions. Get in touch today!
          </p>
        </div>
          ...
          <div>
            ...
            <div className="mt-10">
              ...
              <p className="text-gray-700 mb-4">
                <strong>Life Insurance Corporation of India</strong><br />
                Khalilabad Branch (28L)<br />
                Sugar Mill Road<br />
                Khalilabad, Uttar Pradesh - 272175
              </p>
              <p className="text-gray-700 mb-6">
                <strong>Phone:</strong> 07562-224174<br />
                <strong>Email:</strong> bo_359@licindia.com
              </p>
              ...
              <div className="mt-6">
                ...
                <div className="flex space-x-4">
                  <a
                    href="https://www.facebook.com/BalramRiturajChaukikar"
                    target="_blank"
                  ...
                  <a
                    href="https://twitter.com/BalramLic02431"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://www.linkedin.com/in/balram-lic-281bb4199/"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://www.instagram.com/balramlicadvisor/"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://www.youtube.com/@balramchoukikar843"
                    target="_blank"
                    rel="noopener noreferrer"
